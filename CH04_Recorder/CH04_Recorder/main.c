...
// kevin - I'm taking the queue field out of the struct because the callback already
// gets the queue as a parameter
...
int	main(int argc, const char *argv[])
{
	...
	// kevin - I'm moving a lot of variable definitions so that it's easier
	// to speak to them in the narrative of the text, rather than introduce them
	// and come back to them three pages later.
